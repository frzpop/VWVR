...
struct  OperationType_t2199153750 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(OperationType_t2199153750, ___value___1)); }
